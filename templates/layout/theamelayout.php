...
<!--    <link rel="stylesheet" href="css/responsive.css">-->
    <!-- fevicon -->
    <?php echo $this->Html->css('fevicon.png'); ?>
<!--    <link rel="icon" href="images/fevicon.png" type="image/gif" />-->
    <!-- Scrollbar Custom CSS -->
    <?php echo $this->Html->css('jquery.mCustomScrollbar.min.css'); ?>
...
<?php echo $this->Html->script('jquery-3.0.0.min.js')?>
<!--<script src="js/jquery-3.0.0.min.js"></script>-->
<?php echo $this->Html->script('plugin.js')?>
<!--<script src="js/plugin.js"></script>-->
<!-- sidebar -->
<!--<script src="js/jquery.mCustomScrollbar.concat.min.js"></script>-->
<?php echo $this->Html->script('jquery.mCustomScrollbar.concat.min.js')?>
...
<?php echo $this->Html->script('https:cdnjs.cloudflare.com/ajax/libs/fancybox/2.1.5/jquery.fancybox.min.js')?>
</body>
</html>
